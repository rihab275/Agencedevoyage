...
main (int argc, char *argv[])
{
  ...
  GtkWidget *YassResVoituresWind;
  GtkWidget *YassSkytravelMainWind;
  GtkWidget *YassCatWind;
  GtkWidget *YassInscriWind,*a;
  ...
  //YassResVoituresWind = create_YassResVoituresWind ();
  //gtk_widget_show (YassResVoituresWind);
